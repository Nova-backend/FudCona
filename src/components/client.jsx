...
function Client() {
  ...
  return (
    <div className='h-[100vh] w-[100vw] bg-white' id='formClient' onSubmit={handleSUm}>
      <div className='h-[80vh] w-[32vw] bg-[#FAFAF5] ml-auto mr-auto mt-24 rounded-xl' id='shadow'>
        ...
        <form action="" >
          <label htmlFor="">Client</label><input type="text" placeholder='Client Name' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] mt-2 ml-8 w-[28vw] ' name='name' value={data.name} />
          <label htmlFor="">Category</label><input type="text" placeholder='Choose category' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='category' value={data.category} />
          <label htmlFor="">Representative</label><input type="text" placeholder='Representative' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='representative' value={data.representative} />
          <label htmlFor="">Date of creation</label><input type="text" placeholder='Month & year' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='date' value={data.date} />
          <label htmlFor="">Address</label><input type="text" placeholder='Province,district,sector,cell' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='address' value={data.address} />
          <label htmlFor="">Email</label><input type="text" placeholder='Email' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='email' value={data.email} />
          <label htmlFor="">Phone</label><input type="text" placeholder='Phone' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='phone' value={data.phone} />
          <label htmlFor="">Bank Account(IBAN)</label><input type="text" placeholder='Code' className='border-b-2 border-b-[#AEAEAE] bg-[#FAFAF5] ml-8 w-[28vw] mt-2' name='code' value={data.code} />
