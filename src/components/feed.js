...
function Feed() {
  return (
    ...
    <div>
        <p class="text-black  relative xl:top-[28px] xl:text-[18px] text-[14px] xl:left-[50%]  left-[2%] top-3 ">Overview</p>
        <div class="flex relative xl:left-[190%] left-[50%]   xl:space-x-[30px] space-x-[10px] xl:mt-[1px] -mt-[6px]  ">
    ...
    {/* _____________all clients________ */}
     <div className='xl:h-[500px] xl:w-[770px] bg-[#FAFAF5]  absolute xl:top-[33%] xl:left-[23.69%] top-[25%] h-[470px]  w-[210px] ml-1 '>
