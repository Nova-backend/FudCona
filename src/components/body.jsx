      ...
      <div className="bg-[#FAFAF5] h-[150vh] w-[85%] float-right right-0">
        ...
        <div className="grid lg:grid-cols-3 gap-[200px] p-[25px] w-[70%] absolute left-[15.5rem] top-[30px]">
          <div className="h-[160px] w-[320px] bg-white hover:bg-[#989A38] border-[10px to-black] block p-[30px] border-solid border-2 border-[#989A38] rounded-lg">
            ...
            <h1 className="text-center font-[600]  text-[20px]">60</h1>
          </div>
          ...
          <div className="h-[160px] w-[320px] bg-white hover:bg-[#989A38] border-[10px to-black] p-[25px] border-solid border-2 border-[#989A38] rounded-lg">
            <p className="text-center font-[100] p-[5px] text-[30px] opacity-[0.8] mt-[10px]">
              Orders
            </p>
            <h1 className="text-center font-[600] p-[5px] text-[20px]">5756</h1>
          </div>
        </div>
        <div className="min-h-[200px] w-[80.5%] bg-white absolute top-[32%] left-[18.5%] border-solid border-2 border-[#989A38] shadow-2xl">
          <h1 className="font[600] text-[23px] p-2 pr-[56rem]">Today's trends</h1>

          <h2 className="p-2 mt-[-12px]  text-[15px] pr-[56rem]">25 May 2022 09:39 AM</h2>
